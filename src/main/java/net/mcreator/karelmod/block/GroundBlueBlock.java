...
public class GroundBlueBlock extends KarelModModElements.ModElement {
	@ObjectHolder("karel_mod:ground_blue")
	public static final Block block = null;
	public GroundBlueBlock(KarelModModElements instance) {
		super(instance, 1);
	}
