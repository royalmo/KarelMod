...
import net.mcreator.karelmod.procedures.CreateNukeProcedure;
...
public class NukeBombBlock extends KarelModModElements.ModElement {
	@ObjectHolder("karel_mod:nuke_bomb")
	public static final Block block = null;
	public NukeBombBlock(KarelModModElements instance) {
		super(instance, 35);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.METAL).hardnessAndResistance(1f, 10f).lightValue(14).notSolid());
			setRegistryName("nuke_bomb");
		}
		...
		public void onEntityCollision(BlockState state, World world, BlockPos pos, Entity entity) {
			...
			int z = pos.getZ();
			{
				...
				CreateNukeProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
