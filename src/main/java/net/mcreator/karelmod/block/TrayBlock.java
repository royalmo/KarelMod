...
public class TrayBlock extends KarelModModElements.ModElement {
	@ObjectHolder("karel_mod:tray")
	public static final Block block = null;
	@ObjectHolder("karel_mod:tray")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public TrayBlock(KarelModModElements instance) {
		super(instance, 23);
	...
	public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
		event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("tray"));
	}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("tray");
		}
