...
import net.mcreator.karelmod.procedures.ActivateBombProcedure;
...
public class BombBlock extends KarelModModElements.ModElement {
	@ObjectHolder("karel_mod:bomb")
	public static final Block block = null;
	public BombBlock(KarelModModElements instance) {
		super(instance, 10);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.METAL).hardnessAndResistance(1.2f, 5f).lightValue(0).notSolid());
		...
		public void onEntityCollision(BlockState state, World world, BlockPos pos, Entity entity) {
			...
			int z = pos.getZ();
			{
				...
				ActivateBombProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
