...
public class GroundRedBlock extends KarelModModElements.ModElement {
	@ObjectHolder("karel_mod:ground_red")
	public static final Block block = null;
	public GroundRedBlock(KarelModModElements instance) {
		super(instance, 2);
	}
