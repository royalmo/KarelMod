...
public class NormalWallBlock extends KarelModModElements.ModElement {
	@ObjectHolder("karel_mod:normal_wall")
	public static final Block block = null;
	public NormalWallBlock(KarelModModElements instance) {
		super(instance, 3);
	}
