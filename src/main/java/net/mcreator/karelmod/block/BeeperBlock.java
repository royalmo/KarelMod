...
public class BeeperBlock extends KarelModModElements.ModElement {
	@ObjectHolder("karel_mod:beeper")
	public static final Block block = null;
	public BeeperBlock(KarelModModElements instance) {
		super(instance, 7);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.PLANTS).sound(SoundType.GLASS).hardnessAndResistance(1f, 7f).lightValue(12).doesNotBlockMovement()
					.notSolid());
			this.setDefaultState(this.stateContainer.getBaseState().with(WATERLOGGED, false));
			setRegistryName("beeper");
		}
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			return VoxelShapes.create(0.3D, 0.3D, 0.3D, 0.7000000000000001D, 0.7000000000000001D, 0.7000000000000001D).withOffset(offset.x, offset.y,
					offset.z);
		}
