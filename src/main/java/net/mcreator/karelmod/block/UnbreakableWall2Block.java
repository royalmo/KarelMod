...
public class UnbreakableWall2Block extends KarelModModElements.ModElement {
	@ObjectHolder("karel_mod:unbreakable_wall_2")
	public static final Block block = null;
	public UnbreakableWall2Block(KarelModModElements instance) {
		super(instance, 5);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("unbreakable_wall_2");
		}
