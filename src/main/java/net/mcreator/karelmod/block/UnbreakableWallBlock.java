...
public class UnbreakableWallBlock extends KarelModModElements.ModElement {
	@ObjectHolder("karel_mod:unbreakable_wall")
	public static final Block block = null;
	public UnbreakableWallBlock(KarelModModElements instance) {
		super(instance, 4);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("unbreakable_wall");
		}
