...
import net.mcreator.karelmod.gui.TeleportSetupGui;
...
public class TeleporterOnBlockRightClickedProcedure extends KarelModModElements.ModElement {
	public TeleporterOnBlockRightClickedProcedure(KarelModModElements instance) {
		super(instance, 17);
	}
				...
				if (_ent instanceof ServerPlayerEntity) {
					...
					NetworkHooks.openGui((ServerPlayerEntity) _ent, new INamedContainerProvider() {
						...
						public ITextComponent getDisplayName() {
							return new StringTextComponent("TeleportSetup");
						}

						@Override
						public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
							return new TeleportSetupGui.GuiContainerMod(id, inventory, new PacketBuffer(Unpooled.buffer()).writeBlockPos(_bpos));
						}
					}, _bpos);
				}
			}
