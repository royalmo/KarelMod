...
public class TrayGuiGui extends KarelModModElements.ModElement {
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
			...
			this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 43, 52) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return (new ItemStack(BeeperBlock.block, (int) (1)).getItem() == stack.getItem());
				}
			}));
			this.customSlots.put(1, this.addSlot(new SlotItemHandler(internal, 1, 115, 52) {
				@Override
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
			...
			this.font.drawString("Current", 34, 38, -16724788);
			this.font.drawString("Needed", 108, 38, -16724788);
		}
