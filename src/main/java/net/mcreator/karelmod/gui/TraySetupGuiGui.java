...
import net.mcreator.karelmod.procedures.TraySetupGuiThisGUIIsOpenedProcedure;
import net.mcreator.karelmod.procedures.TraySetupGuiApplyProcedure;
...
public class TraySetupGuiGui extends KarelModModElements.ModElement {
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
				...
				this.addSlot(new Slot(inv, si, 0 + 8 + si * 18, 0 + 142));
			{
				...
				TraySetupGuiThisGUIIsOpenedProcedure.executeProcedure($_dependencies);
			}
		}
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote) {
				KarelModMod.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
			...
			this.font.drawString("" + (KarelModModVariables.TraySetupLog) + "", 34, 67, -12829636);
		}
		...
		if (buttonID == 0) {
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				TraySetupGuiApplyProcedure.executeProcedure($_dependencies);
			}
		}
	}
