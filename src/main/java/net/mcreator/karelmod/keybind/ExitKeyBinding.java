...
public class ExitKeyBinding extends KarelModModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;
	public ExitKeyBinding(KarelModModElements instance) {
		super(instance, 13);
	...
	public void initElements() {
		keys = new KeyBinding("key.mcreator.exit", GLFW.GLFW_KEY_G, "key.categories.movement");
